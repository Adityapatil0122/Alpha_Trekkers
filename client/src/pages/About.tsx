...
export default function About() {
  return (
    <>
      {/* ─── HERO BANNER ─── */}
      <section className="relative min-h-[32rem] overflow-hidden bg-white pt-24 sm:min-h-[38rem] lg:h-[90vh] lg:min-h-[42rem] lg:max-h-[920px]">
        <img
          src="/destinations/Devkund Waterfall in lush surroundings.png"
          alt="Devkund waterfall"
          className="absolute inset-0 h-full w-full object-cover"
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(15,23,42,0.76),rgba(15,23,42,0.48),rgba(15,23,42,0.16))]" />
        ...
        <motion.div
          ...
          className="hero-copy relative mx-auto flex h-full max-w-7xl items-center px-4 py-14 sm:px-6 sm:py-16 lg:px-8"
        >
          <div>
            <p className="section-script !text-primary-300">
          ...
          >
            <div className="story-route-frame relative mx-auto max-w-[40rem] overflow-hidden shadow-[0_28px_70px_rgba(15,23,42,0.24)]">
              <img
                ...
                className="story-route-frame__image h-[320px] w-full object-cover sm:h-[450px]"
              />
            ...
            {destinations.map((destination) => (
              ...
              >
                <Link to="/trips" className="group block">
                  <div className="relative mx-auto h-[8.75rem] w-[8.75rem] sm:h-[11.5rem] sm:w-[11.5rem]">
                    <img
